...
- Parameters verified: num_malicious_clients, num_clients_to_keep (>1 for Multi-Krum)
- Note: Multi-Krum selects m closest updates and averages them (m = num_clients_to_keep)
"""
