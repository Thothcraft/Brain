...
async def start_device_pairing(
    ...
    if existing_device:
        ...
        if authorization and isinstance(authorization, str):
            ...
            token_authorizes_existing_device = token_user.userId == existing_device.userId
        ...
        if not token_authorizes_existing_device:
            ...
            # Expired JWTs and a login for the intended new owner cannot
            # authenticate as the previous owner. Once the old heartbeat is
